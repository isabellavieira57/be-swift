...
class RegisterViewController: UIViewController, UserHandler, UITextFieldDelegate  {
...
//            userDAO.saveRegistration(name: nameTxt!, email: emailTxt!, password: passwordTxt!, country: countryTxt!, major: courseTxt!)
            userDAO.saveRegistration(name: nameTxt!, email: emailTxt!, password: passwordTxt!)
        }
    }
