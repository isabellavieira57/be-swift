...
//        self.addSubview(progressBar)
    ...
    func setTableView()
    {
        ...
        self.tableRowHeight = 47*yScale
        
        self.sortTableView = UITableView(frame: CGRect(x: 5*xScale, y: endOfMainView, width: 310*xScale, height: self.tableRowHeight * CGFloat(numberOfLines)))
